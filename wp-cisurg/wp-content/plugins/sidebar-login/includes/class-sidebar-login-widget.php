	    ...
	    if ( $show == 'logged_out' ) {
		    ...
		    if ( ! empty( $this->instance['show_lost_password_link'] ) && $this->instance['show_lost_password_link'] == 1 ) {
		    	...
		    	$links['lost_password'] = array(
	    			'text' => __( 'Esqueceu a senha?', 'sidebar-login' ),
    ...
    public function widget( $args, $instance ) {
		...
		// Logged out user
			...
			$login_form_args = apply_filters( 'sidebar_login_widget_form_args', array(
		        ...
		        'label_username' 	=> __( 'Matrícula', 'sidebar-login' ),
		        'label_password' 	=> __( 'Senha', 'sidebar-login' ),
		        'label_remember' 	=> __( 'Manter logado', 'sidebar-login' ),
		        'label_log_in' 		=> __( 'Acessar &rarr;', 'sidebar-login' ),
