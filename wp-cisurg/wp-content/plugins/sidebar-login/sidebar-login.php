...
class Sidebar_Login {
	...
	public function enqueue() {
		...
		$sidebar_login_params = array(
			...
			'is_ssl'           => is_ssl() ? 1 : 0,
			'i18n_username_required' => __( 'Por favor, digite a matrícula', 'sidebar-login' ),
			'i18n_password_required' => __( 'Por favor, digite a senha', 'sidebar-login' ),
	...
	public function ajax_handler() {
		...
		if ( ! is_wp_error( $user ) ) {
			...
			if ( $user->errors ) {
				...
				$result['error'] = __( 'Por favor, entre com o usuário e senha para acessar.', 'sidebar-login' );
			}
		}
