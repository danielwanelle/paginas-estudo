<?php get_header();
/*
 * Template Name: Justificativas-Apontador
 */
?>
...
<div class="container" id="form-ajax-resposta">
  ...
  if($status=='Aguardando lançamento'):
              ...
              <form id="form-ajax" method="post" action="#">
                <div class="input-group mb-3">
                  ...
                  <div class="input-group-prepend" id="button-addon3">
                    ...
                    <input type="hidden" name="page" id="form_ajax_page" value="justificativas-apontador"/>
                    <input class="btn btn-danger" type="submit" value="Recusar"/>
              </form>
              <form id="form-ajax" method="post" action="#">
                    <input type="hidden" name="id_post" id="form_ajax_id_post" value="<?php the_ID(); ?>" />
                    <input type="hidden" name="status" id="form_ajax_status" value="Aprovada"/>
                    <input type="hidden" name="page" id="form_ajax_page" value="justificativas-apontador"/>
