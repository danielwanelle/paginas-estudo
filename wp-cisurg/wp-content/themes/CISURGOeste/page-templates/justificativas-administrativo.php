<?php get_header();
/*
 * Template Name: Justificativas-Administrativo
 */
?>
...
<div class="container" id="form-ajax-resposta">
  ...
  $ids_medicos=author_ids_by_role_administrativo();
              ...
              <form id="form-ajax" method="post" action="#">
                <div class="input-group mb-3">
                  ...
                  <div class="input-group-prepend" id="button-addon3">
                    ...
                    <input type="hidden" name="page" id="form_ajax_page" value="justificativas-administrativo"/>
