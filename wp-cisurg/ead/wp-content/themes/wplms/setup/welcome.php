	...
	function get_demo_plugins(){
		return apply_filters('get_demo_plugins_array',array(
				...
				'demo11'=>array(
					...
					'installed'=>(file_exists(VIBE_PATH.'/../../plugins/wplms_demo11/')?(is_plugin_active('wplms_demo11/wplms_demo11.php')?1:0):0)
				),
				'demo12'=>array(
					'label'=>'Demo 12',
					'slug'=>'wplms_demo12',
					...
					'installed'=>(file_exists(VIBE_PATH.'/../../plugins/wplms_demo12/')?(is_plugin_active('wplms_demo12/wplms_demo12.php')?1:0):0)
				),
				'demo13'=>array(
					'label'=>'Demo 13',
					'slug'=>'wplms_demo13',
					...
					'installed'=>(file_exists(VIBE_PATH.'/../../plugins/wplms_demo13/')?(is_plugin_active('wplms_demo13/wplms_demo13.php')?1:0):0)
				),
				'demo14'=>array(
					'label'=>'Demo 14',
					'slug'=>'wplms_demo14',
					...
					'installed'=>(file_exists(VIBE_PATH.'/../../plugins/wplms_demo14/')?(is_plugin_active('wplms_demo14/wplms_demo14.php')?1:0):0)
				),
				'demo15'=>array(
					'label'=>'Demo 15',
					'slug'=>'wplms_demo15',
					...
					'installed'=>(file_exists(VIBE_PATH.'/../../plugins/wplms_demo15/')?(is_plugin_active('wplms_demo15/wplms_demo15.php')?1:0):0)
				),
				'demo16'=>array(
					'label'=>'Demo 16',
					'slug'=>'wplms_demo16',
					...
					'installed'=>(file_exists(VIBE_PATH.'/../../plugins/wplms_demo16/')?(is_plugin_active('wplms_demo16/wplms_demo16.php')?1:0):0)
				)
			));
	}
			...
			<div class="changelog about-integrations">
				...
				<div class="wplms-feature feature-section col three-col">
					...
					<div>
						...
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/gutenberg.png' ?>" alt="">
						</p>
					...
					<div>
						<h4>Demo 15</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/installer/images/demo15.jpg' ?>" alt="">
						</p>
					...
					<div>
						<h4>Demo 16</h4>
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/installer/images/demo16.jpg' ?>" alt="">
						</p>
						<a href="http://wplms.io/demos/demo16" class="button" target="_blank">Link</a>
					</div>
				...
				<div class="wplms-feature feature-section col three-col">
					...
					<div>
						...
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/parentuser.png' ?>" alt="">
						</p>
					...
					<div>
						...
						<p style="max-height: 220px; overflow: hidden;">
							<img src="<?php echo VIBE_URL.'/setup/data/uploads/new/pdf-certificate.png' ?>" alt="">
						</p>
